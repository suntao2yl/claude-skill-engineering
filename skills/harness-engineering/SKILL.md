...
- `AGENTS.md` (project root) — cross-tool role contract; auto-generated by `engineering_init` and refreshed on phase transitions. Hand-edits outside the BEGIN/END markers are preserved.
